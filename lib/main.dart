...
class _ABCLoggingScreenState extends State<ABCLoggingScreen> {
  ...
  final List<String> behaviors = ["Verbal aggression", "Threat", "Physical aggression", "Not in designated area", "Leaving building/campus", "Work Refusal", "Property destruction", "Property misuse", "Stealing", "Sleeping"];
